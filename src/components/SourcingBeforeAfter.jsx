...
export default function SourcingBeforeAfter() {
  return (
    <div className="mt-5 grid grid-cols-2 gap-3 md:gap-4">
      {/* 크로닛 전 — 끝없는 스크롤 */}
      <div className="flex flex-col items-center rounded-2xl border border-white/10 bg-white/[0.03] p-4 md:p-5">
        ...
        <p className="mt-3 text-center text-xs font-medium text-white/35">끝없이 스크롤 · 복불복</p>
      </div>

      {/* 크로닛 후 — 터진 것만 정리 */}
      <div className="flex flex-col items-center rounded-2xl border border-[#0064FF]/30 bg-white/[0.04] p-4 md:p-5">
