    ...
    >
      ...
      >
        ...
        <div className="mb-6 text-center">
          ...
          <h3 className="text-xl font-bold text-gray-900">서비스 이용 동의</h3>
        ...
        <button
          ...
          disabled={!checked}
          className="mt-4 w-full rounded-2xl bg-[#0064FF] px-6 py-3.5 text-base font-bold text-white shadow-[0_10px_30px_-10px_rgba(3,199,90,0.5)] transition-all hover:bg-[#0052D6] disabled:cursor-not-allowed disabled:opacity-40 active:scale-[0.98]"
        >
          동의하고 계속하기
        </button>
      </div>
