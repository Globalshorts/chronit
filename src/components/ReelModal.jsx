...
import { Eye, Heart, MessageCircle, Sparkles, X, ChevronLeft, ChevronRight, Bookmark } from 'lucide-react'
...
export default function VideoModal({ clip, onClose, onSave, saved = false }) {
