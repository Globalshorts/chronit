...
const PAINS = [
  { img: '/pain/scroll.webp', lqip: 'data:image/webp;base64,', tag: '막막한 시작', line: '뭘 찍을지 뭐라 말할지 몰라 하루 종일 고민' },
  { img: '/pain/cost.webp', lqip: 'data:image/webp;base64,', tag: '외주 비용', line: '대본 외주는 편당 몇 만원씩' },
  { img: '/pain/luck.webp', lqip: 'data:image/webp;base64,', tag: '감으로 복불복', line: '감으로 쓴 대본, 조회수는 복불복' },
]
    ...
    <div className="w-full px-5 py-14 md:py-20">
      <div className="mx-auto w-full max-w-5xl">
        ...
        <div className="mt-8 grid grid-cols-1 gap-3 md:mt-10 md:grid-cols-3 md:gap-5">
          {PAINS.map((p) => (
            <div key={p.tag} className="flex overflow-hidden rounded-2xl glass glass-c md:block md:rounded-3xl">
          ...
          <div className="grid grid-cols-2 gap-3 md:gap-5">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-[#0064FF]/40 bg-cover bg-center md:rounded-3xl" style={{ backgroundImage: `url(${BA_AFTER_LQIP})` }}>
              ...
              <div className="absolute inset-0 flex flex-col p-4 md:p-6">
                ...
                <div className="mt-auto md:flex md:items-baseline md:gap-2"><span className="block text-[10px] font-semibold uppercase tracking-wider text-white/50 md:text-[11px]">대본 쓰기</span><span className="text-xl font-bold text-[#7DA2FF] md:text-3xl">단 3분</span></div>
              </div>
            </div>
          </div>
