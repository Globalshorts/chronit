  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#020617] font-sans break-keep text-slate-100 selection:bg-blue-500/30">
        ...
        <div className="mx-auto grid max-w-4xl grid-cols-2 gap-3 md:grid-cols-4 md:gap-4">
          {[
            ...
            <a
              key={id}
              href={`#${id}`}
              className="group flex items-center justify-center gap-2 rounded-2xl border border-white/10 bg-white/[0.02] px-4 py-3 text-base font-bold text-slate-300 transition-all hover:border-blue-400/40 hover:bg-blue-500/10 hover:text-white md:text-lg"
            >
      ...
      <section className="px-5 py-16 text-center md:px-8 md:py-24">
        <Link
          to="/"
          className="group inline-flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-6 py-3 text-base font-bold text-slate-200 transition-all hover:border-blue-500/40 hover:bg-blue-500/10 hover:text-blue-400 md:text-lg"
        >
  ...
  <section id={id} className="px-5 py-16 md:px-8 md:py-24">
    <div className="mx-auto max-w-4xl">
      <div className="mb-10 flex items-center gap-4 md:mb-14">
        ...
        <div>
          <p className="text-[10px] font-black tracking-[0.3em] text-blue-500 uppercase md:text-sm">
            {subtitle}
          </p>
...
const mdComponents = {
  ...
  blockquote: (props) => (
    <blockquote
      className="my-4 rounded-r-2xl border-l-4 border-yellow-500/60 bg-yellow-500/[0.06] py-3 pr-4 pl-5 text-base leading-relaxed text-yellow-100 md:text-lg"
      {...props}
    />
  ),
  code: ({ inline, ...props }) =>
