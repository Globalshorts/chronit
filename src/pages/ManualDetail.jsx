...
const GUIDE_STEPS = [
  ...
  { img: '/guide/02-menu.jpg', title: '② 메뉴에서 [콘셉트/스타일] 열기', desc: "메뉴의 **콘셉트/스타일** 탭을 열면 위에 **🔍 스타일 찾기**와 **⚙️ 자동화 세팅** 두 개가 나뉘어 있어요. 이 탭만 처음에 한 번 해두면 끝이에요.", note: "**스타일 찾기 → 자동화 세팅** 순서로 하면 돼요." },
