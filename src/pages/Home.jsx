          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
            ...
            {[
              ...
              <div key={p.name} className={`flex flex-col rounded-2xl bg-white p-6 shadow-[0_1px_3px_rgba(20,20,20,0.05)] ${p.hot ? 'border-2 border-[#0064FF]' : 'border border-gray-100'}`}>
                ...
                <div className="mt-2.5 inline-flex items-center rounded-full bg-[#0064FF]/10 px-3 py-1 text-sm font-extrabold text-[#0064FF]">하루 약 {(Math.round(p.price / 30 / 10) * 10).toLocaleString('ko-KR')}원 꼴</div>
